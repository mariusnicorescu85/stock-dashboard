  ...
  return (
    <section className="grid gap-4 sm:grid-cols-2">
      ...
      <div className="rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4 space-y-2">
        ...
        <div className="grid gap-3 text-sm sm:grid-cols-2">
          <div>
            <p className="text-xs text-emerald-200/80">Effective stock</p>
          ...
          <div>
            <p className="text-xs text-emerald-200/80">Days until run out</p>
            <p className="mt-1 text-2xl font-semibold tabular-nums text-emerald-100">
              {days != null ? days : "—"}
            </p>
          </div>
          ...
          <div>
            <p className="text-xs text-emerald-200/80">Run-out date</p>
          ...
          <div>
            <p className="text-xs text-emerald-200/80">Order-by date</p>
            <p className="mt-1 text-base font-semibold text-emerald-100">
